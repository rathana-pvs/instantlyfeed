      ...
      <div className="max-w-[800px] mx-auto relative z-10">
        ...
        <div className="space-y-12 text-lg leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          ...
          <section className="relative">
            ...
            <p>
              Welcome to InstantlyFeed. We value your privacy and are committed to protecting your personal data. This policy explains how we collect and use information when you visit our platform.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              You have the right to access, correct, or delete any personal information we hold about you. For any privacy-related requests, please contact our data protection officer at <span className="font-bold border-b border-[var(--accent-red)]" style={{ color: 'var(--text-primary)' }}>privacy@instantlyfeed.com</span>.
            </p>
          </section>
