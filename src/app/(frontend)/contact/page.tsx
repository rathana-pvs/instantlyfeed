            ...
            <div className="space-y-12">
              <div className="flex gap-6 group">
                ...
                <div>
                  ...
                  <p className="font-display font-bold text-xl" style={{ color: 'var(--text-primary)' }}>hello@instantlyfeed.com</p>
                </div>
              </div>
              ...
              <div className="flex gap-6 group">
                ...
                <div>
                  ...
                  <p className="font-display font-bold text-xl" style={{ color: 'var(--text-primary)' }}>legal@instantlyfeed.com</p>
                </div>
              </div>
